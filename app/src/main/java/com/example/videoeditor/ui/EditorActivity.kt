 ...
 * timeline editing, and triggering export. A real app would split import/
 * export/project-list into their own screens; kept together here to show the
...
class EditorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addClipButton.setOnClickListener { pickVideo.launch("video/*") }
    ...
    /**
     * Rebuilds the ExoPlayer playlist from the current project so live preview
     * roughly matches the trim points. NOTE: this preview path does not apply
     * GL filters/overlays live (that requires wiring Media3's Effects into
     * ExoPlayer's video pipeline via setVideoEffects) -- the export pipeline
     * in TimelineExporter is the source of truth for how effects actually look.
     */
